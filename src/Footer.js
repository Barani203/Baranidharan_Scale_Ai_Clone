...
export default function Footer() {
  return (
   ...
   {/* <!-- footer --> */}
<footer class="py-lg-8 py-5 footer bg-darkbg-subtle">
  <div class="container">
    <div class="row gy-4">
      <div class="col-lg-4 col-12">
        ...
        <div class="d-flex flex-column gap-4">
          <div>
            <img src="../assets/images/mentor/geeks-mentor.svg" alt="" class="logo-reverse" />
          </div>
          <div>
            <p class="mb-0 text-light">Connecting founders and marketers with battle-hardened mentors that genuinely enjoy helping people.</p>
          </div>
          {/* <!-- Instagram --> */}
    ...
    <div class="row mt-lg-7 mt-5">
      ...
      <div class="col-lg-6 offset-lg-3 col-12">
        <span class="d-flex text-light justify-content-center">
          ©
          ...
          Scale-UI Mentor. All Rights Reserved.
        </span>
      </div>
    </div>
  </div>
